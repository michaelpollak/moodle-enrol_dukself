...
Feature: Users can auto-enrol themself in courses where self enrolment is allowed
  ...
  @javascript
  Scenario: Dukself-enrolment enabled as guest
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add "Dukself enrolment" enrolment method with:
  ...
  Scenario: Dukself-enrolment enabled
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "Dukself enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
    And I log out
  ...
  Scenario: Dukself-enrolment enabled requiring an enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "Dukself enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  Scenario: Dukself-enrolment disabled
    Given I log in as "student1"
    When I am on "Course 1" course homepage
    Then I should see "You can not enrol yourself in this course"

  Scenario: Dukself-enrolment enabled requiring a group enrolment key
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "Dukself enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Edit a dukself-enrolled user's enrolment from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "Dukself enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
  ...
  @javascript
  Scenario: Unenrol a dukself-enrolled student from the course participants page
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    When I add "Dukself enrolment" enrolment method with:
      | Custom instance name | Test student enrolment |
