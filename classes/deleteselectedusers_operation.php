...
/**
 * A bulk operation for the dukself enrolment plugin to delete selected users enrolments.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_dukself_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_dukself');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_dukself');

        return new enrol_dukself_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/dukself:unenrol", $manager->get_context())) {
            return false;
        }
