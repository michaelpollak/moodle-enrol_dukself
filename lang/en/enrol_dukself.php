...
/**
 * Strings for component 'enrol_dukself', language 'en'.
 *
...
$string['cohortnonmemberinfo'] = 'Only members of cohort \'{$a}\' can dukself-enrol.';
$string['cohortonly'] = 'Only cohort members';
$string['cohortonly_help'] = 'Dukself enrolment may be restricted to members of a specified cohort only. Note that changing this setting has no effect on existing enrolments.';
...
// Extension autosuspend
$string['autosuspend'] = 'Autosuspend users';
$string['autosuspend_desc'] = 'Users will be suspended after completion.';
$string['autosuspend_help'] = 'Users will be suspended after completion. If disabled, users will stay active until manually suspended.';
// </mod by DUK>
...
$string['expirymessageenrollersubject'] = 'Dukself enrolment expiry notification';
$string['expirymessageenrollerbody'] = 'Dukself enrolment in the course \'{$a->course}\' will expire within the next {$a->threshold} for the following users:

{$a->users}

To extend their enrolment, go to {$a->extendurl}';
$string['expirymessageenrolledsubject'] = 'Dukself enrolment expiry notification';
...
$string['messageprovider:expiry_notification'] = 'Dukself enrolment expiry notifications';
...
$string['pluginname'] = 'Dukself enrolment';
...
$string['dukself:config'] = 'Configure self enrol instances';
$string['dukself:holdkey'] = 'Appear as the self enrolment key holder';
$string['dukself:manage'] = 'Manage enrolled users';
$string['dukself:unenrol'] = 'Unenrol users from course';
$string['dukself:unenrolself'] = 'Unenrol self from the course';
...
$string['sendexpirynotificationstask'] = 'Dukself enrolment send expiry notifications task';
...
$string['syncenrolmentstask'] = 'Dukself enrolment synchronise enrolments task';
$string['unenrol'] = 'Unenrol user';
$string['unenroldukselfconfirm'] = 'Do you really want to unenrol yourself from course "{$a}"?';
...
If you have not done so already, you should edit your profile page so that we can learn more about you:
  ...
  {$a->profileurl}';
$string['privacy:metadata'] = 'The Dukself enrolment plugin does not store any personal data.';
